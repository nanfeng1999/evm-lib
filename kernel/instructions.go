...
var (
	errWriteProtection       = errors.New("github.com/nanfeng1999/evm-lib: write protection")
	errReturnDataOutOfBounds = errors.New("github.com/nanfeng1999/evm-lib: return data out of bounds")
	errExecutionReverted     = errors.New("github.com/nanfeng1999/evm-lib: execution reverted")
	errMaxCodeSizeExceeded   = errors.New("github.com/nanfeng1999/evm-lib: max code size exceeded")
)
...
func opSha3(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	...
	if evm.vmConfig.EnablePreimageRecording {
		evm.StateDBHandler.AddPreimage(common.BytesToHash(hash), data)
	}
...
func opBalance(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	slot := stack.peek()
	slot.Set(evm.StateDBHandler.GetBalance(common.BigToAddress(slot)))
	return nil, nil
}
...
func opExtCodeSize(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	slot := stack.peek()
	slot.SetUint64(uint64(evm.StateDBHandler.GetCodeSize(common.BigToAddress(slot))))
...
func opSload(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	loc := stack.peek()
	val := evm.StateDBHandler.GetState(contract.Address(), common.BigToHash(loc))
...
func opSstore(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	...
	val := stack.pop()
	evm.StateDBHandler.SetState(contract.Address(), loc, common.BigToHash(val))
...
func opSuicide(pc *uint64, evm *EVM, contract *Contract, memory *Memory, stack *Stack) ([]byte, error) {
	...
	evm.StateDBHandler.AddBalance(common.BigToAddress(stack.pop()), balance)
